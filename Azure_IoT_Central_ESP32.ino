...
void setup()
{
  ...
  pinMode (PIEZOELECTRIC_PIN, INPUT);
...
void loop()
{
piezoelectric_value = analogRead (PIEZOELECTRIC_PIN);
potentiometer_value = analogRead (POTENTIOMETER_PIN);

 if (piezoelectric_value > 250){
